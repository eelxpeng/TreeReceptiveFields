...
# python sparsel1.py --batch-size 1000 --epochs 100 --dataset dbpedia --num-layer 3 --shape 1 --num-neuron 1024 --wd 1e-5 --name sparsel1-dbpedia-l3-con-1024
# python sparsel1.py --batch-size 1000 --epochs 100 --dataset agnews --num-layer 3 --shape 1 --num-neuron 1024 --wd 1e-5 --name sparsel1-agnews-l3-con-1024
# python sparsel1.py --batch-size 1000 --epochs 100 --dataset yelp --num-layer 3 --shape 1 --num-neuron 1024 --wd 1e-5 --name sparsel1-yelp-l3-con-1024
# python sparsel1.py --batch-size 1000 --epochs 100 --dataset sogounews --num-layer 3 --shape 1 --num-neuron 1024 --wd 1e-5 --name sparsel1-sogounews-l3-con-1024

python sparsel1.py --batch-size 100 --epochs 300 --dataset tox --target 0 --num-layer 3 --shape 1 --num-neuron 512 --wd 1e-5 --name sparsel1-tox-0-l3-con-512
python sparsel1.py --batch-size 100 --epochs 300 --dataset tox --target 1 --num-layer 3 --shape 1 --num-neuron 512 --wd 1e-5 --name sparsel1-tox-1-l3-con-512
python sparsel1.py --batch-size 100 --epochs 300 --dataset tox --target 2 --num-layer 3 --shape 1 --num-neuron 512 --wd 1e-5 --name sparsel1-tox-2-l3-con-512
python sparsel1.py --batch-size 100 --epochs 300 --dataset tox --target 3 --num-layer 3 --shape 1 --num-neuron 512 --wd 1e-5 --name sparsel1-tox-3-l3-con-512
python sparsel1.py --batch-size 100 --epochs 300 --dataset tox --target 4 --num-layer 3 --shape 1 --num-neuron 512 --wd 1e-5 --name sparsel1-tox-4-l3-con-512
python sparsel1.py --batch-size 100 --epochs 300 --dataset tox --target 5 --num-layer 3 --shape 1 --num-neuron 512 --wd 1e-5 --name sparsel1-tox-5-l3-con-512
python sparsel1.py --batch-size 100 --epochs 300 --dataset tox --target 6 --num-layer 3 --shape 1 --num-neuron 512 --wd 1e-5 --name sparsel1-tox-6-l3-con-512
python sparsel1.py --batch-size 100 --epochs 300 --dataset tox --target 7 --num-layer 3 --shape 1 --num-neuron 512 --wd 1e-5 --name sparsel1-tox-7-l3-con-512
python sparsel1.py --batch-size 100 --epochs 300 --dataset tox --target 8 --num-layer 3 --shape 1 --num-neuron 512 --wd 1e-5 --name sparsel1-tox-8-l3-con-512
python sparsel1.py --batch-size 100 --epochs 300 --dataset tox --target 9 --num-layer 3 --shape 1 --num-neuron 512 --wd 1e-5 --name sparsel1-tox-9-l3-con-512
python sparsel1.py --batch-size 100 --epochs 300 --dataset tox --target 10 --num-layer 3 --shape 1 --num-neuron 512 --wd 1e-5 --name sparsel1-tox-10-l3-con-512
python sparsel1.py --batch-size 100 --epochs 300 --dataset tox --target 11 --num-layer 3 --shape 1 --num-neuron 512 --wd 1e-5 --name sparsel1-tox-11-l3-con-512
