...
if args.num_layer==1:
    ...
    kernel_stride = [(5, 2), (5, 2)]
    fcwidths = [80, 40]
elif args.num_layer==3:
    kernel_stride = [(5, 2), (5, 2), (5, 2)]
    fcwidths = [80, 40, 20]
elif args.num_layer==4:
    # 1644 -> 800 -> 800 -> 400 -> 200
    kernel_stride = [(5, 2), (5, 1), (5, 2), (5, 2)]
    fcwidths = [80, 80, 40, 25]
elif args.num_layer==5:
    # 1644 -> 800 -> 800 -> 400 -> 400 -> 200
    kernel_stride = [(5, 2), (5, 1), (5, 2), (5, 1), (5, 2)]
    fcwidths = [80, 80, 40, 40, 25]
elif args.num_layer==6:
    kernel_stride = [(5, 2), (5, 1), (5, 2), (5, 1), (5, 2), (5, 1)]
    fcwidths = [80, 80, 40, 40, 25, 25]
elif args.num_layer==7:
    kernel_stride = [(5, 2), (5, 1), (5, 1), (5, 2), (5, 1), (5, 2), (5, 1)]
    fcwidths = [80, 80, 80, 40, 40, 25, 25]
